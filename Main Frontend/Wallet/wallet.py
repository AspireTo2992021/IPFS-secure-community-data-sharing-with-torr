...
from utils import generate_transaction_data, convert_transaction_data_to_bytes, calculate_hash ,validate_signature
...
class Transaction:
    ...
    def add_public_key_to_transaction(self,public_key):
        return {"data" : str({
